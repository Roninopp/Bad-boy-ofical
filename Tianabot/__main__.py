...
TIANA_IMG = f"https://telegra.ph/file/3a025803a74ec2e9f79f4.jpg"
TIANA_VIDA = f"https://telegra.ph/file/3a025803a74ec2e9f79f4.jpg"
TIANA_VIDB = f"https://telegra.ph/file/3a025803a74ec2e9f79f4.jpg"
    ...
    if chat.type == "private":
        ...
        try:
            bot.send_message(
               ...
               [
                 [                   
                    InlineKeyboardButton(text="Dᴏɴᴀᴛᴇ Mᴇ", url=f"https://t.me/Badboi_official"),
                 ]
               ]
             )
            )
